...
This registers the predefined demo services (weather, search, finance, ai, data, compute) into the on-chain registry.
...
The agent will:
- Query the Lodestar registry for weather, search, finance, ai, data, and compute services
